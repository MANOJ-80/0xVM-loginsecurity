...
```yaml
vm_id: "vm-001"
collector_url: "http://192.168.56.20:3000/api/v1/events"
poll_interval: 2
event_id: 4625
```
...
| VM | Role | IP | RAM | Disk |
|----|------|----|-----|------|
| VM 1 | Source (generates failed logins) | 192.168.56.10 | 2 GB | 40 GB |
| VM 2 | Collector + Backend + MSSQL | 192.168.56.20 | 4 GB | 60 GB |
...
net use \\192.168.56.10\C$ /user:baduser wrongpassword
...
3. Set static IPs (192.168.56.10 and 192.168.56.20)
